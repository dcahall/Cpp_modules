...
/*   Updated: 2022/06/13 16:18:08 by dcahall          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(std::string name) : ClapTrap(name) {
	std::cout << "ScavTrap string constructor called" << std::endl;	setName(name);
	setDamage(20);
	setHealth(100);
	setEnergy(50);
}
...
ScavTrap::~ScavTrap(void) {
	std::cout << "ScavTrap destructor ClapTrap called" << std::endl;
}
